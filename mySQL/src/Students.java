...
public class Students {
    ...
    public Students(String nrMatricol, String nume, String prenume, String cnp, String dataNasterii) {
    ...
    public static void showStudents() {
        ...
        try {
            ...
            while (result.next()) {
                ...
                ++count;
                System.out.println("Student: Nr - " + count + " ID: " + id + " Nr. Matricol: " + nrMatricol +
